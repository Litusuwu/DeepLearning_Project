...
def build_densenet_model():
    base_model = DenseNet121(weights=None, include_top=False, input_shape=input_shape)  # SIN PESOS PRE-ENTRENADOS
    x = GlobalAveragePooling2D()(base_model.output)
    x = Dropout(0.5)(x)  # Asegurar que es la misma capa usada en entrenamiento
