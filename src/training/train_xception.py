...
if __name__ == '__main__':
    train_config = load_config("configs/train_config_xception.yaml")
    data_config = load_config("configs/data_paths.yaml")

    epochs = train_config.get("epochs", 10)
    batch_size = train_config.get("batch_size", 32)
    input_shape = tuple(train_config.get("input_shape", [299, 299, 3]))
    ...
    model = build_xception_model(input_shape)
